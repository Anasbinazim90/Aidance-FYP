...
class ProfileScreenVendor extends StatefulWidget {
  ProfileScreenVendor({super.key});

  @override
  State<ProfileScreenVendor> createState() => _ProfileScreenVendorState();
}

class _ProfileScreenVendorState extends State<ProfileScreenVendor> {
  ...
  Future<void> fetchCurrentUserData() async {
    if (user != null) {
      ...
      setState(() {
        vendorData = DonorDoc.data() as Map<String, dynamic>?;
        vendorAddress = vendorData?['address'];
      });

      // Fetch balance after setting userAddress
      if (vendorAddress != null) {
        _nativeBalancecontroller.getBalanceApi(vendorAddress!);
        _nativeBalancecontroller.getBalanceApi(vendorAddress!);
      }
    }
  ...
  void copyToClipboard(context) {
    FlutterClipboard.copy(vendorData!['address'] ?? '').then((value) {
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${Utils().shortenAddress(vendorData!['address'])}',
