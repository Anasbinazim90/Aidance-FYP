...
import 'package:aidance_app/screens/vendorFlow/controllers/vendor_bottom_nav_controller.dart';
...
class BottomNavScreenVendor extends StatelessWidget {
  BottomNavScreenVendor({super.key});

  final bottom_nav_controller_enduser = Get.put(BottomNavControllerVendor());
  @override
          ...
          child: Obx(
            () => Row(
              ...
              children: [
                ...
                // ),
                _bottomAppBarItem(
                    icon: Icons.wallet, page: 0, context, label: "Scan"),
                _bottomAppBarItem(
