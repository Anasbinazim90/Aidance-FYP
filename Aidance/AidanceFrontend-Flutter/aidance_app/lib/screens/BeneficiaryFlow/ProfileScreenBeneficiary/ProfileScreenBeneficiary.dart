...
class ProfileScreenBeneficiary extends StatefulWidget {
  ProfileScreenBeneficiary({super.key});

  @override
  State<ProfileScreenBeneficiary> createState() =>
      _ProfileScreenBeneficiaryUserState();
}

class _ProfileScreenBeneficiaryUserState
    extends State<ProfileScreenBeneficiary> {
  ...
  Future<void> fetchCurrentUserData() async {
    if (user != null) {
      ...
      setState(() {
        beneficiaryData = DonorDoc.data() as Map<String, dynamic>?;
        beneficiaryAddress = beneficiaryData?['address'];
      });

      // Fetch balance after setting userAddress
      if (beneficiaryAddress != null) {
        _nativeBalancecontroller.getBalanceApi(beneficiaryAddress!);
      }
    }
    log(beneficiaryData.toString());
  }

  void copyToClipboard(context) {
    FlutterClipboard.copy(beneficiaryData!['address'] ?? '').then((value) {
                  ...
                  : SingleChildScrollView(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: AnimateList(interval: 30.ms, effects: [
                            FadeEffect(duration: 300.ms),
                            SlideEffect(
                                begin: const Offset(0, 0.1), duration: 200.ms)
                          ], children: [
                            Text(
                              "${beneficiaryData!['username']}",
                              style: TextStyle(
                                fontSize: 24.sp,
                                color: Colors.black,
                                fontWeight: FontWeight.bold,
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${Utils().shortenAddress(beneficiaryData!['address'])}',
