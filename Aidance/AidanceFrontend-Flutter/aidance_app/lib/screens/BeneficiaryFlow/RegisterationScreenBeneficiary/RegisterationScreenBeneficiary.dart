...
class RegisterationScreenBeneficiary extends StatefulWidget {
  @override
  _RegisterationScreenBeneficiaryState createState() =>
      _RegisterationScreenBeneficiaryState();
}

class _RegisterationScreenBeneficiaryState
    extends State<RegisterationScreenBeneficiary> {
      ...
      child: Column(
        children: [
          ...
          buildTextField(
            ...
            ngoNumberController,
            (val) {
              if (val!.isValidRef) return 'Please enter a valid Ngo Number';
              return null;
            },
          ),
          buildTextField(
            ...
            false,
            false,
            benificiaryCodeController,
            (val) {
              if (val!.isValidName)
                return 'Please enter a valid Benificiary Code';
              return null;
            },
          ),
                  ...
                  onTap: () {
                    ...
                    if (isSignupScreen) {
                      _controller.createUser(
                          ...
                          signuppass.text,
                          ngoNumberController.text,
                          address_controller.addressList.value.address
                              .toString(),
                          benificiaryCodeController.text,
