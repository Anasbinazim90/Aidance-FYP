...
class NGOCampaignDetailScreen extends StatefulWidget {
  ...
  @override
  State<NGOCampaignDetailScreen> createState() =>
      _NGOCampaignDetailScreenState();
}

class _NGOCampaignDetailScreenState extends State<NGOCampaignDetailScreen> {
          ...
          onPressed: () {
            Get.to(
                ...
                () => BeneficiaryListScreen(
                      campaignId: widget.proposal.tokenId!,
                    ));
          },
          label: const Text('Show Beneficiaries'),
        ),
      ),
