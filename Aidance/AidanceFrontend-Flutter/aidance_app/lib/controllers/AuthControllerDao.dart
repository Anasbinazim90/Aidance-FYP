...
class DaoAuthController extends GetxController {
...
//  String get imageurl =>_firebaseUser.value?.photoURL;
  ...
  Future<void> createUser(
    ...
    try {
      ...
      if (user != null) {
        await _firestore.collection('daoUsers').doc(user.uid).set({
          'username': username,
          'email': email,
          'address': address,
  ...
  login(String email, String password, address) async {
    try {
